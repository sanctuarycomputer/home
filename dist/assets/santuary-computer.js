...
define('santuary-computer/pods/site/template', ['exports'], function (exports) {
  ...
  function program9(depth0,data) {
    ...
    data.buffer.push("<div class=\"small-12 columns vertical-center\"><h1 class=\"austincyr-fat animated fadeInDown\">Get in Touch.</h1><a href=\"mailto:hello@sanctuary.computer\" target=\"_blank\"><h3 class=\"brown-light\">hello@sanctuary.computer</h3></a><div id=\"socials\"><a href=\"https://www.facebook.com/sanctuarycomputer\" target=\"_blank\">");
    data.buffer.push(escapeExpression((helper = helpers['fa-icon'] || (depth0 && depth0['fa-icon']),options={hash:{
      'size': (2)
    },hashTypes:{'size': "INTEGER"},hashContexts:{'size': depth0},contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "facebook-official", options) : helperMissing.call(depth0, "fa-icon", "facebook-official", options))));
    data.buffer.push("</a><a href=\"https://github.com/sanctuarycomputer\" target=\"_blank\">");
    data.buffer.push(escapeExpression((helper = helpers['fa-icon'] || (depth0 && depth0['fa-icon']),options={hash:{
      'size': (2)
    },hashTypes:{'size': "INTEGER"},hashContexts:{'size': depth0},contexts:[depth0],types:["STRING"],data:data},helper ? helper.call(depth0, "github", options) : helperMissing.call(depth0, "fa-icon", "github", options))));
...
if (runningTests) {
  ...
  require("santuary-computer/app")["default"].create({"name":"santuary-computer","version":"0.0.0.6d56f5ba"});
}
